        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li <?php if(get_page_name()=="edit_password.php") echo "class='active'"; ?> ><a href="edit_password.php">Edit Password</a></li>
              <li <?php if(get_page_name()=="edit_account.php") echo "class='active'"; ?> ><a href="edit_account.php">Edit Account</a></li>
            ...
            <div class="col-md-3">
               <ul class="nav nav-pills nav-stacked">
                  <?php
                    ...
                    {
                      ?>
                        <li class="active"><a href="#">Admin <span style="color: yellow; padding: 5%;">(This section is for primary admin only)</span></a></li>
